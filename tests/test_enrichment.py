"""
Automated Pytest for hrd-parp-triager-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    OverviewEngine,
    PharmacogenomicDrugMetabolismIntegrationEngine,
    GoalEngine,
    DataModelChangesEngine,
    KnowledgeBaseEngine,
    AgentChangesEngine,
    GenerateDoseAdjustmentRecommendationsEngine,
    ApiChangesEngine,
    HrdparptriageragentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = HrdparptriageragentEnrichmentSuite()
