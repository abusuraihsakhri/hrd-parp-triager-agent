...
**HRD PARP Triager Agent** is an advanced analytical and computational platform implementing Homologous Recombination Deficiency & PARP Inhibitor Response.
...
- **`BRCAMutationClassifierAgent`**: Specialized Sub-Agent 1 for hrd-parp-triager-agent
- **`GenomicScarCalculatorAgent`**: Specialized Sub-Agent 2 for hrd-parp-triager-agent
- **`PARPResponsePredictorAgent`**: Specialized Sub-Agent 3 for hrd-parp-triager-agent
...
docker run -p 8000:8000 hrd-parp-triager-agent
```
